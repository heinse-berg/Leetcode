...
public class Division {
    ...
    public static void main(String[] args) {
        ...
        list.add((Arrays.asList("c", "e")));
        list.add((Arrays.asList("b", "d")));
        list.add((Arrays.asList("b", "e")));

        List<List<String>> queries = new ArrayList<>();
        queries.add(Arrays.asList("x", "x"));
        queries.add(Arrays.asList("a", "c"));

        System.out.println(Arrays.toString(abc.calcEquation(list, new double[] {2,3,4,5,6}, queries)));
    }
}