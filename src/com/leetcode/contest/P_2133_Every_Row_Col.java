...
public class P_2133_Every_Row_Col {

    public boolean checkValid(int[][] matrix) {
        int i, j, a , b, n = matrix.length;
    ...
    public static void main(String[] args) {
        P_2133_Every_Row_Col abc = new P_2133_Every_Row_Col();
        int[][] m = new int[][]
        ...
        System.out.println(abc.checkValid(m)); //[[1,2,3],[3,1,2],[2,3,1]]
    }
}
